...
// Check if artisnova service or something else is managing CamillaDSP
const cmds = [
    'pgrep -a camilla',
    'cat /etc/systemd/system/artisnova.service | grep -i camilla',
    'sudo journalctl -u artisnova -n 10 --no-pager'
];
